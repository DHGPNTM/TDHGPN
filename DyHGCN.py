...
class DyHGCN_H(nn.Module):
    ...
    def __init__(self, opt, dropout=0.3):
        ...
        self.init_weights()
        self.RNN = torch.nn.RNN(ninp, ninp, 2)
        print(self)
    ...
    def forward(self, input, input_timestamp, time_list, diffusion_graph):
        ...
        dynamic_node_emb_dict_time = sorted(dynamic_node_emb_dict.keys())  # dynamic_node_emb_dict.keys()  time_list
        ...
        # att_out, _ = self.RNN(final_embed.cuda())
